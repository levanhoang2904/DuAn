...
function Products() {
    ...
    const AddCard = (IdUser, Idpro, title, price) => {
        console.log('====================================');
        console.log(IdUser, Idpro, title, price);
        console.log('====================================');
        fetch('http://localhost:3000/api/cartpost', {
            ...
            body: JSON.stringify({IdUser, Idpro, title, price  }),
        })
            .then((res) => {
                if (res.status === 200) {
                    return res.json();
    ...
    const [img, setImg] = useState(
        'https://file.hstatic.net/200000536009/collection/vga-rtx-2080_982d76c46b8c4190a177e34de7e04540.png',
    );
                ...
                <div className={styles.info}>
                            ...
                            <Slider {...settings}>
                                <div className={styles.imglist}>
                                    <img
                                        ...
                                        src="https://hoangduongpc.vn/upload/product_images/37844_2080saorus1.png" alt=''
                                    />
                                </div>
                                <div className={styles.imglist}>
                                    <img src="https://hoangduongpc.vn/upload/product_images/37844_2080saorus1.png" />
                                </div>
                                <div className={styles.imglist}>
                                    <img src="https://hoangduongpc.vn/upload/product_images/37844_2080saorus1.png" />
                                </div>
                    ...
                    <div className={styles.price}>
                        ...
                        <div className={styles.button}>
                            ...
                            <button className={styles.btn} onClick={() => {AddCard(id, idproduct, title, price)}} >Thêm vào giỏ hàng</button>
                        </div>
                    </div>
                </div>
            </div>
