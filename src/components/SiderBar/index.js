            ...
            <div className={styles.category}>
                ...
                <div className={styles.categorylists}>
                    <div className={styles.categorylist}>
                        <img className={styles.iconlist} src={ramImage} />
                        <span>
                            Ram
                    ...
                    <div className={styles.categorylist}>
                        ...
                        <span>
                            ...
                            <div className={styles.ramlists}>
                                <div className={styles.ramlist}>
                                    <Link to="/">Nguồn Asus</Link>
                                </div>
                                <div className={styles.ramlist}>
                                    <Link to="/">Nguồn Corsair</Link>
                                </div>
                                <div className={styles.ramlist}>
                                    <Link to="/">Nguồn Cooler Master</Link>
                                </div>
                                <div className={styles.ramlist}>
                                    <Link to="/">Nguồn Xigmatek</Link>
                                </div>
                            </div>
                        </span>
                        <div className={styles.iconright}>
